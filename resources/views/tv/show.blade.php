    ...
    <div class="tv-info border-b border-gray-800">
        ...
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            ...
            @if($tvshow['poster_path'])
                <img src="{{ 'https://image.tmdb.org/t/p/w500/' . $tvshow['poster_path'] }}" alt="no_image"
                class="w-64 lg:w-96">
            @else
                <img src="https://via.placeholder.com/300/000000/FFFFFF?text=No Image" alt="poster"
                class="w-72 h-full pb-14 -mb-14">
            @endif
